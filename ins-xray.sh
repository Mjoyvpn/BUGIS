...
[Unit]
Description=Xray Service ( %i ) By joysmark
...
[Unit]
Description=Trojan-Go Service By joysmark
Documentation=https://t.me/joysmark
Documentation=https://github.com/Mjoyvpn/Mjoyvpn
After=network.target nss-lookup.target
