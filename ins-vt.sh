...
# install v2ray
wget https://raw.githubusercontent.com/Mjoyvpn/BUGIS/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 4433 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 6363 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 2087 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 8443 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 80 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 4433 -j ACCEPT
